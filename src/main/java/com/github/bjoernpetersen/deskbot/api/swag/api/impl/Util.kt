...
fun lookupProvider(manager: ProviderManager, providerId: String): Provider? = manager.getProvider(
    providerId)

fun lookupSuggester(manager: ProviderManager,
    suggesterId: String): Suggester? = manager.getSuggester(suggesterId)
